...
{
    public class TimeControllerNetwork : MonoBehaviour
    {
        ...
        public float timeInterval = 1f;            // how often the clock is updated
        public float timeElapsed;                  // elapsed time since the last update
        [SerializeField] private Text timeDisplay;

        public static TimeControllerNetwork Instance { get; set; }
